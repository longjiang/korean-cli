      ...
      <div class="row">
        ...
        <div class="col-sm-6" :key="'transcript-' + args">
          ...
          <div v-else-if="!loading && !hasSubtitles" class="jumbotron pt-4 pb-3 bg-light">
            <h6>Sorry, this YouTube video does not have Korean closed captions.</h6>
            <p>
              ...
              <b>Korean</b> then the video has
              Korean subtitles.
            </p>
            <p>
              To look for videos with Korean subtitles, search with a Korean
              keyword, and click
              <b>Filter</b>, then
              <b>CC</b>.
            </p>
